...
if c == 'M':
    print("It will take you {} months to pay back the loan.".format(n) )
elif c == 'W':
    print("It will take you {} weeks to pay back the loan.".format(n * 4))
elif c == 'D':
    print("It will take you {} days to pay back the loan.".format(n * 30))
